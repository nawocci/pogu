...
func (a *API) Handler(static http.Handler) http.Handler {
	...
	mux.HandleFunc("GET /api/settings/caveman", a.getCavemanSettings)
	mux.HandleFunc("PUT /api/settings/caveman", a.updateCavemanSettings)
	mux.HandleFunc("POST /api/settings/caveman/sync", a.syncCavemanSkill)
